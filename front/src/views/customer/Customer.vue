    ...
    <div style="height: 60px; border-bottom: 1px solid #7F8A96; display: flex; align-items: center;">
      ...
      <div style="width: fit-content; padding-right: 20px;display: flex; align-items: center;">
        ...
        <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click="router.push('/customer/person')">个人信息</el-dropdown-item>
              <el-dropdown-item @click="router.push('/customer/updatepassword')">修改密码</el-dropdown-item>
